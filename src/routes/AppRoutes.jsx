...
/* ======================= DOCUMENT ======================= */
// const DocumentDashboard = lazy(() => import("../pages/document/DocumentDashboard"));
const DocumentCreatePage = lazy(() => import("../pages/user/UserDocumentFormPage"));
const DocumentPreviewPage = lazy(() => import("../components/constant/DocumentPreview"));
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRoles={["user"]} />}>
        <Route element={<UserLayout />}>
          ...
          />
          <Route
            path={ROUTES.USER_DOCUMENT_DETAIL}
          ...
          />
          <Route
            path={ROUTES.USER_DOCUMENT_CREATE}
            element={<LazyLoad component={DocumentCreatePage} />}
          />
          <Route
            path={ROUTES.USER_DOCUMENT_PREVIEW}
            element={<LazyLoad component={DocumentPreviewPage} />}
          />
        </Route>
      </Route>

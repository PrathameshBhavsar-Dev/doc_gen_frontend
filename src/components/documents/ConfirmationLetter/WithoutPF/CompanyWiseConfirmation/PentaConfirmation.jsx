...
const PentaConfirmation = ({ company = {}, data = {} }) => {
  ...
  // totalSalary is ANNUAL CTC
  const annualCTC = round0(Number(data.totalSalary || 0));

  // Convert annual CTC to monthly salary
    ...
    <>
      ...
      <A4Page headerSrc={company.header} footerSrc={company.footer}>
        <Box mt={2}>
          ...
          <Box mt={6} display="flex" justifyContent="space-between" alignItems="flex-end">
            <Box>
              <Typography>
      ...
      <A4Page headerSrc={company.header} footerSrc={company.footer}>
        ...
        {/* Signature Section - ALIGNED VERSION */}
        <Box mt={8} display="flex" justifyContent="space-between" alignItems="flex-end">
          <Box>
            <Box mt={2} display="flex" alignItems="center" gap={2}>
              {company.signature && (
                <img src={company.signature} alt="Sign" style={{ height: 30 }} />

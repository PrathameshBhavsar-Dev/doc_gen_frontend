...
//         This is to certify that <strong>{mrms} {employeeName}</strong> has done her
//         internship at <strong>QUICK MANAGEMENT SERVICES</strong>.
//       </Typography>

//       <Typography sx={{ fontSize: 13.5, lineHeight: 2, mb: 2 }}>
//         From <strong>{formatDate(startDate)}</strong> –{" "}
//         <strong>{formatDate(endDate)}</strong>. She was designated as{" "}
//         <strong>{designation}</strong>.
//       </Typography>

//       <Typography sx={{ fontSize: 13.5, lineHeight: 2, mb: 6 }}>
//         During the internship she has demonstrated the skills with self-motivation
//         to learn new skills. She performance exceeded our expectations and she was
//         able to complete the given tasks on time. We wish her all the best for her
//         upcoming career.
//       </Typography>

          ...
          <Table size="small" sx={TABLE_STYLE}>
            ...
            <TableBody>
              {salaryRows.map((row, i) => (
                <TableRow key={i}>
                  <TableCell sx={CELL_BASE}>{row[0]}</TableCell>
                  <TableCell align="center" sx={CELL_BASE}>{formatCurrency(row[1])}</TableCell>
                  <TableCell align="center" sx={CELL_BASE}>{formatCurrency(row[2])}</TableCell>
                </TableRow>
              ))}

              <TableRow sx={TOTAL_ROW}>
                <TableCell sx={TOTAL_CELL}>Total Monthly Gross Salary</TableCell>
                <TableCell align="center" sx={TOTAL_CELL}>{formatCurrency(totalMonthly)}</TableCell>
                <TableCell align="center" sx={TOTAL_CELL}>{formatCurrency(totalAnnual)}</TableCell>
              </TableRow>
            </TableBody>
          </Table>
        </TableContainer>

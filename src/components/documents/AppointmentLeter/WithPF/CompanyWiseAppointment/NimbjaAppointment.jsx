  ...
  return (
    <>
        ...
        <Box sx={{ mt: "6mm" }}>
          ...
          >
            ...
            <Box sx={{ fontFamily: "Bahnschrift" }}>
              ...
              {/* SIGNATURE + STAMP */}
              <Grid container spacing={2} alignItems="center" sx={{ mt: "1mm" }}>
                <Grid item>
                  <Box
                    component="img"
                    src={company?.signature}
      ...
      <A4Page headerSrc={company.header} footerSrc={company.footer}>
        ...
        ></Box>
        {/* Signature Block - ALIGNED VERSION */}
        <Box
          sx={{
            display: "flex",
            justifyContent: "space-between",
        ...
        >
          ...
          <Box minWidth="250px" sx={{ fontFamily: "Bahnschrift" }}>
            <Typography sx={{ fontFamily: "Bahnschrift" }}>
              Signature: __________________
            </Typography>
            <Typography mt={2} sx={{ mt: "1mm", fontFamily: "Bahnschrift" }}>

...
/* ================= MAIN COMPONENT ================= */
const CubeageAppointment = ({ company, data }) => {
  if (!company || !data) return null;
      ...
      <A4Layout headerSrc={company.header}>
        ...
        >
          ...
          <Typography mb="5mm" sx={{ fontSize: "14px" }}>
            <strong>Employee Name:</strong> {data.mrms} {data.employeeName}
          </Typography>
      ...
      <A4Layout headerSrc={company.header}>
        <Box sx={{ pt: "24mm" }}>
          ...
          <Grid container direction="column" rowSpacing={1} mb="10mm">
            <Grid item>Name: {data.employeeName}</Grid>

            <Grid item>Designation: {data.position}</Grid>

            <Grid item>Location: {data.address}</Grid>
          </Grid>

...
//   /* ── Sidebar ── */
//   /* Sidebar spacer keeps the flex layout width consistent since the
//      real sidebar below is position: fixed and removed from flow. */
//   .dp-sidebar-spacer {
//     width: 224px;
//     flex-shrink: 0;
//   }
...
//       overflow-y: visible;
//     }
//     .dp-sidebar-spacer { display: none; }
//     .dp-card    { flex: 1; min-width: 130px; }
//     .dp-topbar  { padding: 0 14px; }
//     .dp-a4      { width: 100%; min-height: unset; }
//     .dp-logo-name { display: none; }
...
//   // ── Fixed sidebar horizontal alignment ──
//   // The sidebar is position:fixed (so it never scrolls with the page),
//   // so we track where its spacer sits in the flex layout and pin the
//   // real sidebar's `left` to that same x-position. Recalculated on
//   // mount and on window resize so it stays aligned with .dp-layout's
//   // max-width/centering at any viewport size.
//   const sidebarSpacerRef = useRef(null);
...
//       {/* ── Layout ── */}
//       <div className="dp-layout">
//         {/* Spacer — occupies the sidebar's slot in the flex layout so
//             main content doesn't shift, since the real sidebar below
//             is position: fixed and out of normal document flow. */}
//         <div className="dp-sidebar-spacer" ref={sidebarSpacerRef} />

//         {/* ── Sidebar (fixed — stays in place while page scrolls) ── */}
//         <aside className="dp-sidebar" style={{ left: sidebarLeft }}>
//           <div className="dp-card">
//             <div className="dp-card-label">Documents</div>

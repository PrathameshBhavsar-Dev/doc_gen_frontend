...
// //   {
// //     img: icon,
// //     value: "10", // (later from another API)
...
// //   {
// //     img: icon3,
// //     value: "4", // (later from another API)
// //     label: "Active Users",
// //     badge: "+5",
// //   },
// // ];
...
// //         "http://localhost:5000/documents/getalldoc"
// //       );
...
//           "http://localhost:5000/api/v1/documents/getalldoc?page=1"
//         );
...
//           const res = await axios.get(
//             `http://localhost:5000/api/v1/documents/getalldoc?page=${i}`
//           );
...
//         {/* Stats Wrapper */}
//         <div className="bg-[#8B5CF6]/10 rounded-2xl sm:rounded-3xl p-3 sm:p-5 lg:p-8">
...
const API_ALL_DOCUMENTS = `${BASE_URL}/documents/getalldoc`;
...
const HeroDashBoardSection = () => {
  ...
  useEffect(() => {
    const fetchDocuments = async () => {
      try {
        // First call to get total and page count
        const firstRes = await axios.get(`${API_ALL_DOCUMENTS}?page=1`);
        ...
        // Fetch remaining pages to get all documents
        for (let i = 2; i <= totalPages; i++) {
          const res = await axios.get(`${API_ALL_DOCUMENTS}?page=${i}`);
          allDocs = [...allDocs, ...res.data.data];
        }

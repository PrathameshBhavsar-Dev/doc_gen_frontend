...
const AdminHistoryPage = () => {
  ...
  const generatedUsers = [...new Set(tableData.map((d) => d.generatedBy))];
  ...
  const filteredData = tableData.filter((item) => {
    ...
    if (generatedBy && item.generatedBy !== generatedBy) return false;
      ...
      >
        ...
        >
          ...
          <Select
            ...
            displayEmpty
            sx={{ height: 48, borderRadius: "14px", background: "#F3F4F6" }}
            renderValue={(v) => (v ? v : "Select Document Type")}
          >
          ...
          <Select
            ...
            displayEmpty
            sx={{ height: 48, borderRadius: "14px", background: "#F3F4F6" }}
            renderValue={(v) => (v ? v : "Select Company")}
          >
            {companies.map((comp) => (
          ...
          <Select
            ...
            displayEmpty
            sx={{ height: 48, borderRadius: "14px", background: "#F3F4F6" }}
            renderValue={(v) => (v ? v : "Generated by")}
          >
          ...
          <Select
            ...
            displayEmpty
            sx={{ height: 48, borderRadius: "14px", background: "#F3F4F6" }}
            renderValue={(v) => (v ? v : "Select months")}
          >
            {months.map((m) => (
